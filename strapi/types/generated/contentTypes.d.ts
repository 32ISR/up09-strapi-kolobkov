...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    lessons: Schema.Attribute.Relation<'oneToMany', 'api::leasson.leasson'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::course.course'
...
export interface ApiLeassonLeasson extends Struct.CollectionTypeSchema {
  collectionName: 'leassons';
  info: {
    displayName: 'Lesson';
    pluralName: 'leassons';
    singularName: 'leasson';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPeoplePeople extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['student', 'teacher']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::leasson.leasson': ApiLeassonLeasson;
